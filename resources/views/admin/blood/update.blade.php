...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <div class="d-flex align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Update Data Darah</h6>
        </div>
    </div>
    <div class="card-body">
        <form class="form-blood-update" action="{{ route('api.admin.blood.update', [ 'id' => $id ] ) }}" method="PUT" data-id="{{ $id }}">
            @csrf
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <label class="form-label">Code</label>
                    <input type="text" class="form-control" id="code"
                        placeholder="Code" name="code" disabled>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
...
@push('scripts')
<script src="{{ asset('js/pages/blood/update.js') }}"></script>
@endpush
