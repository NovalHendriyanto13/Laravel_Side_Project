...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <div class="d-flex align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Tambah Stock Darah</h6>
        </div>
    </div>
    <div class="card-body">
        <form class="form-blood-stock-create" action="{{ route('api.admin.bloodStock.create') }}" method="POST">
            @csrf
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <label class="form-label">Nama</label>
                    <input type="text" class="form-control" id="stock_no"
                        placeholder="No Stock" name="stock_no">
                </div>
                <div class="col-sm-6">
