...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <div class="d-flex align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Users Update</h6>
            
        </div>
    </div>
    <div class="card-body">
        <form class="user form-user-update" action="{{ route('api.user.update', ['id' => $id]) }}" method="PUT" data-id="{{$id}}">
            @csrf
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <label class="form-label">NIK</label>
                    <input type="text" class="form-control" id="nik"
                        placeholder="NIK" name="nik" disabled>
                </div>
                <div class="col-sm-6">
