    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto text-center mb-5">
                <h2>Pemesanan</h2>
                <p>Update pemesanan untuk <span id="hospital-name"></span></p>
            </div>
        </div>
        ...
        <div class="row mb-5" data-aos="fade-up" data-aos-delay="200">
            <div class="col-12">
                <div class="tour-filters">
                    <form action="{{ route('api.order.update', ['id' => $id ]) }}" method="POST" class="form-order-update" data-id="{{ $id }}">
                        @csrf
...
<script src="{{ asset('js/guest/order/update_non_bdrs.js') }}"></script>
@endpush